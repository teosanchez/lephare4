...
if(($pagina-1) > 0) 
       {
       echo "<a href='index.php?cuerpo=rejilla_est_enf_anuales.php&pagina=".($pagina-1)."'>< Anterior</a> ";    
       }    
   for ($i=1; $i<=$total_paginas; $i++)
       ...
       if ($pagina == $i)
           ...
           {
           echo "<a href='index.php?cuerpo=rejilla_est_enf_anuales.php&pagina=$i'>$i</a>&nbsp;";
           } 
        }   
   if(($pagina + 1)<=$total_paginas)
       {
       echo " <a href='index.php?cuerpo=rejilla_est_enf_anuales.php&pagina=".($pagina+1)."'>Siguiente ></a>";
       }
